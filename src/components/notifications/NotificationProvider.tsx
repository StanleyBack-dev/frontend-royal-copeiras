      ...
      <div className="fixed top-6 right-6 z-50 flex flex-col gap-3 items-end">
        {notifications.map((n) => (
          ...
          >
            ...
            {n.type === 'error' && (
              <svg width="20" height="20" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="#ef4444" strokeWidth="2"/><path stroke="#ef4444" strokeWidth="2" d="M8 8l8 8M16 8l-8 8"/></svg>
            )}
            {n.type === 'warning' && (
              <svg width="20" height="20" fill="none" viewBox="0 0 24 24"><path stroke="#eab308" strokeWidth="2" d="M12 8v4m0 4h.01"/><circle cx="12" cy="12" r="10" stroke="#eab308" strokeWidth="2"/></svg>
            )}
            {n.type === 'info' && (
              <svg width="20" height="20" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="#c9a227" strokeWidth="2"/><path stroke="#c9a227" strokeWidth="2" d="M12 8v4m0 4h.01"/></svg>
            )}
            <span>{n.message}</span>
          </div>
        ))}
