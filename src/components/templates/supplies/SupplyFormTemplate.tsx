...
export interface SupplyFormTemplateProps<T extends Record<string, unknown>> {
  title: string;
  values: T;
...
export default function SupplyFormTemplate<T extends Record<string, unknown>>({
  title,
  values,
  setValues,
  fields,
