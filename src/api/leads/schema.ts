...
export const LeadSchema = z.object({
  ...
  addressStreet: nullableToUndefined(z.string().optional().or(z.literal(""))),
  addressNumber: nullableToUndefined(z.string().optional().or(z.literal(""))),
  addressComplement: nullableToUndefined(
    z.string().optional().or(z.literal("")),
  ),
  addressNeighborhood: nullableToUndefined(
    z.string().optional().or(z.literal("")),
  ),
