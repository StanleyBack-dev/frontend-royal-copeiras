...
export const LEAD_LEGAL_NAME_MAX_LENGTH = 160;
export const LEAD_ADDRESS_MAX_LENGTH = 255;
export const LEAD_ADDRESS_STREET_MAX_LENGTH = 160;
export const LEAD_ADDRESS_NUMBER_MAX_LENGTH = 20;
export const LEAD_ADDRESS_COMPLEMENT_MAX_LENGTH = 120;
export const LEAD_ADDRESS_NEIGHBORHOOD_MAX_LENGTH = 120;
export const LEAD_ADDRESS_CITY_MAX_LENGTH = 80;
export const LEAD_ADDRESS_STATE_LENGTH = 2;
export const LEAD_ADDRESS_ZIP_CODE_MASK_LENGTH = 9;
